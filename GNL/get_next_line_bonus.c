...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/04/23 17:07:12 by romvan-d          #+#    #+#             */
/*   Updated: 2022/04/23 17:33:43 by romvan-d         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	*ft_bzero(void *str, size_t len)
{
	...
	ptr = (unsigned char *) str; // demander a Antoine ; est ce que assigner ca change les valeurs dans ptr et dans str qd on itere sur ptr
	i = 0;
	while (len > 0)
	{
		ptr[i] = 0;
